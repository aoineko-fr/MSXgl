...
enum LVGM_DEVICE
{
	...
	LVGM_DEV_MOONSOUND = 0b10000000, // Include Moonsound data (YMF278/OPL4)
	// 
	LVGM_DEV_AY8910    = LVGM_DEV_PSG,
	LVGM_DEV_YM2413    = LVGM_DEV_MSXMUSIC,
	LVGM_DEV_OPLL      = LVGM_DEV_MSXMUSIC,
	LVGM_DEV_Y8950     = LVGM_DEV_MSXAUDIO,
	LVGM_DEV_OPL1      = LVGM_DEV_MSXAUDIO,
	LVGM_DEV_K051649   = LVGM_DEV_SCC,
	LVGM_DEV_K052539   = LVGM_DEV_SCCI,
	LVGM_DEV_YMF278    = LVGM_DEV_MOONSOUND,
	LVGM_DEV_OPL4      = LVGM_DEV_MOONSOUND,
};
