...
#define VDP_USE_MODE_T2				1	// MSX2		Screen 0 Width 80
#define VDP_USE_MODE_G3				1	// MSX2		Screen 4
#define VDP_USE_MODE_G4				1	// MSX2		Screen 5
#define VDP_USE_MODE_G5				1	// MSX2		Screen 6
...
#define PRINT_USE_BITMAP			1	// Allow use of Bitmap font (G4-G7)
#define PRINT_USE_VRAM				1	// Allow use of VRAM stored font (G4-G7)
#define PRINT_USE_SPRITE			1	// Allow use of Sprite font (G3-G7)
#define PRINT_USE_FX_SHADOW			1	// [Bitmap] Allow use of text shadow
#define PRINT_USE_FX_OUTLINE		1	// [Bitmap] Allow use of text outline
