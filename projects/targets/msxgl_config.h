...
#define BIOS_USE_VDP				0	// Give access to Main-ROM routines related to VDP
#define BIOS_USE_PSG				0	// Give access to Main-ROM routines related to PSG
#define BIOS_USE_SUBROM				0	// Allow use of Sub-ROM routines (MSX 2/2+/turbo R)
#define BIOS_USE_DISKROM			0	// Allow use of Disk-ROM routines
