...
PLY_LW_DATA_OFFSETINSTRUMENTCURRENTSTEP:
	add hl, de
PLY_LW_DATA_OFFSETTRACKINVERTEDVOLUME = .+1
PLY_LW_REGISTERS_OFFSETSOFTWAREPERIODLSB = .+1
PLY_LW_DATA_OFFSETPTTRACK = .+2
PLY_LW_DATA_OFFSETINSTRUMENTSPEED:
	ld de, #PLY_LW_READLINE+1
PLY_LW_DATA_OFFSETPTINSTRUMENT = .+1
    ldi
PLY_LW_DATA_OFFSETPTBASEINSTRUMENT = .+1
PLY_LW_REGISTERS_OFFSETSOFTWAREPERIODMSB:
	ldi
PLY_LW_DATA_OFFSETISPITCHUPDOWNUSED = .+1
PLY_LW_DATA_OFFSETTRACKPITCHDECIMAL = .+2
    ld de, #PLY_LW_PTARPEGGIOS+1
PLY_LW_DATA_OFFSETTRACKPITCHSPEED:
	ldi
PLY_LW_DATA_OFFSETTRACKPITCHINTEGER:
	ldi
PLY_LW_DATA_OFFSETPTARPEGGIOOFFSET = .+1
PLY_LW_DATA_OFFSETCURRENTARPEGGIOVALUE = .+2
PLY_LW_DATA_OFFSETISARPEGGIOTABLEUSED:
	ld de, #PLY_LW_PTPITCHES+1
PLY_LW_DATA_OFFSETPTARPEGGIOTABLE:
	ldi
...
PLY_LW_DATA_OFFSETCURRENTPITCHTABLEVALUE:
	ld e, a
PLY_LW_DATA_OFFSETPTPITCHTABLE = .+1
    ld d, #0x0
    add hl, de
