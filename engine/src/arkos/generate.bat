...
echo ; █  █ █  ▀▀  ▄█  █  █ ▀▄█ █▄ │  ██ █ ██   ██ █ ▀█▄▀ ▄██                       >> %low%_player.asm
echo ; ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀────────┘                                                >> %low%_player.asm
echo ;  by Guillaume 'Aoineko' Blanchard under CC BY-SA license                     >> %low%_player.asm
echo ;==============================================================================>> %low%_player.asm
echo ; Autogenerated Arkos %UP% player for MSX-GL library                           >> %low%_player.asm
echo ;  on %DATE% at %TIME%                                                         >> %low%_player.asm
echo ;                                                                              >> %low%_player.asm
echo ; Arkos Tracker and the Z80 players are coded and designed                     >> %low%_player.asm
echo ;  by Julien Névo (aka Targhan/Arkos) under MIT License.                       >> %low%_player.asm
echo ;==============================================================================>> %low%_player.asm
