...
#define MSXMUS_REG_USER_MOD_MUL		0x00
...
//  │	└────────────────────────── Vibrato on/off switch. When this bit is '1', vibrato will be applied to the slot.
//  └────────────────────────────── Amplitude modulation on/off switch. When this bit is '1', amplitude modulation wil be epplied to the slot. 
#define MSXMUS_REG_USER_CAR_MUL		0x01
...
#define MSXMUS_REG_USER_MOD_ATT		0x02
...
//  └───┴────────────────────────── This bit controls the level of key scaling. In key scale mode, the level of attenuation increases as pitch rises, to 1.5 dB/oct, 3 dB/oct, 6 dB/oct, and 0 dB/oct.
#define MSXMUS_REG_USER_CAR_ATT		0x03
...
#define MSXMUS_REG_USER_MOD_RATE	0x04
...
//	│	│	│	│	└───┴───┴───┴── Decay Rate defines the decay time
//  └───┴───┴───┴────────────────── Attack Rate defines the attack time of the sounds
#define MSXMUS_REG_USER_CAR_RATE	0x05
...
#define MSXMUS_REG_USER_MOD_SUS		0x06
...
//	│	│	│	│	└───┴───┴───┴── Sustain Level is the critical point that, when sustaining sound has been attenuated to the prescribed level, the level is maintained thereafter. With percussive tone, it is the critical point of change from decay mode to release mode.
//  └───┴───┴───┴────────────────── Release Rate is the disappearing rate of sustaining sounds after key OFF. For percussive tone, attenuation above the sustain level is expressed with decay rate and attenuation below the sustain level with release rate.
#define MSXMUS_REG_USER_CAR_SUS		0x07
...
#define MSXMUS_REG_RHYTHM			0x0E


//-----------------------------------------------------------------------------
// R#0F    OPLL Test Data
//-----------------------------------------------------------------------------
#define MSXMUS_REG_TEST				0x0F


//-----------------------------------------------------------------------------
// R#1x    F-Number LSB 8 bits
//-----------------------------------------------------------------------------
#define MSXMUS_REG_FERQ_0			0x10
#define MSXMUS_REG_FERQ_1			0x11
#define MSXMUS_REG_FERQ_2			0x12
#define MSXMUS_REG_FERQ_3			0x13
#define MSXMUS_REG_FERQ_4			0x14
#define MSXMUS_REG_FERQ_5			0x15
#define MSXMUS_REG_FERQ_6			0x16
#define MSXMUS_REG_FERQ_7			0x17
#define MSXMUS_REG_FERQ_8			0x18
...
#define MSXMUS_REG_CTRL_0			0x20
#define MSXMUS_REG_CTRL_1			0x21
#define MSXMUS_REG_CTRL_2			0x22
#define MSXMUS_REG_CTRL_3			0x23
#define MSXMUS_REG_CTRL_4			0x24
#define MSXMUS_REG_CTRL_5			0x25
#define MSXMUS_REG_CTRL_6			0x26
#define MSXMUS_REG_CTRL_7			0x27
#define MSXMUS_REG_CTRL_8			0x28
...
#define MSXMUS_REG_INST_0			0x30
#define MSXMUS_REG_INST_1			0x31
#define MSXMUS_REG_INST_2			0x32
#define MSXMUS_REG_INST_3			0x33
#define MSXMUS_REG_INST_4			0x34
#define MSXMUS_REG_INST_5			0x35
// If (0x0E.5 == 0)
#define MSXMUS_REG_INST_6			0x36
#define MSXMUS_REG_INST_7			0x37
#define MSXMUS_REG_INST_8			0x38
...
//	│	│	│	│	└───┴───┴───┴── Snare Drum volume
//  └───┴───┴───┴────────────────── High Hat volume
#define MSXMUS_REG_HHSD_VOL			0x37
...
//	│	│	│	│	└───┴───┴───┴── Top Cymbal
//  └───┴───┴───┴────────────────── Tom-tom volume
#define MSXMUS_REG_TOMTCY_VOL		0x38
