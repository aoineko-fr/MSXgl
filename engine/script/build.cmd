...
if /I %Ext%==bin (
	...
	echo 10 CLS : KEY OFF > %ProjDir%\emul\bin\autoexec.bas
	if /I %Target%==BIN (
		echo 20 PRINT"Loading..." >> %ProjDir%\emul\bin\autoexec.bas
		echo 30 BLOAD"%ProjName:~0,8%.%Ext%",r >> %ProjDir%\emul\bin\autoexec.bas
	) else (
		echo 20 PRINT"Loading USR..." >> %ProjDir%\emul\bin\autoexec.bas
		echo 30 DEF USR=^&HC007 >> %ProjDir%\emul\bin\autoexec.bas
		echo 40 BLOAD"%ProjName:~0,8%.%Ext%" >> %ProjDir%\emul\bin\autoexec.bas
	)
