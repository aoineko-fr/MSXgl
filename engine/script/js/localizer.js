			...
			switch(obj.type)
			{
				...
				case lineTypeText:
					...
					else
					{
						...
						case "IT":  // Italian
						case "ITA":
						case "PL":  // Polish (need [żąłśćęźń])
						case "POL":
						case "PT":  // Portuguese
						case "POR":
						case "ES":  // Spanish, Castilian
						case "SPA":
						case "SK":  // Slovak (need [žŕľšťýďčĺň])
						case "SLK":
						case "SLO":
						case "SV":  // Swedish
						case "SWE":
						case "TR":  // Turkish (need [ı])
						case "TUR":
						...
						case "UK":  // Ukrainian (need [іїєґ])
						case "UKR":
						case "RU":  // Russian (need [ё])
						case "RUS":
