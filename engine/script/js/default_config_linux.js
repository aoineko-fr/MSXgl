...
Compiler  = `${ToolsDir}sdcc-4.2.0/bin/sdcc`;
Assembler = `${ToolsDir}sdcc-4.2.0/bin/sdasz80`;
Linker    = `${ToolsDir}sdcc-4.2.0/bin/sdcc`;
MakeLib   = `${ToolsDir}sdcc-4.2.0/bin/sdar`;
Hex2Bin   = `${ToolsDir}MSXtk/bin/MSXhex_linux`;
MSXDOS    = `${ToolsDir}build/MSXDOS/`;
DskTool   = `${ToolsDir}build/DskTool/dsktool_linux`;
Emulator  =
