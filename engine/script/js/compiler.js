...
module.exports.compile = function (file, size, seg)
{
	...
	if (fileExt == ".c")
	{
		...
		let SDCCParam = `-c -mz80 --vc -DTARGET=TARGET_${Target} -DMSX_VERSION=MSX_${Machine} -I${ProjDir} -I${LibDir}src -I${LibDir}content -I${ToolsDir} -I${IncludeDir} ${AddOpt} ${file} -o ${OutDir}`;
